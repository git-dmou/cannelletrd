 ...
 *
 * AVANT de lancer le test !!! --> cf run config : external tool -->  pour lancer un script de delete
 *
 */
...
public class ModuleScreensCreationNONREGRESSIONTest {
...
//                --> et la transforme en une locale "Thaleia" en recherchant cette locale dans la table Locale !
    ...
    @Test
    void createModuleScreensNonRegressionTestFor_basiquesDeLaClasseVirtuelle_moduleDeTestPartiel() throws DetailedException, URISyntaxException {
        Parameters parameters;
        ResourcesHandler handler;
        List<ParsedObject<IContent>> moduleScreenList = null;
...
//        FakeLocale locale = new FakeLocale("FR");
    ...
    @Test
    void createModuleScreensNonRegressionTestFor_basiquesDeLaClasseVirtuelle_MOCKITO() throws DetailedException, URISyntaxException {

        thaleiaDependenciesManagement:{
